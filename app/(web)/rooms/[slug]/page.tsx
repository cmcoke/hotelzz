...
const RoomDetail = (props: { params: { slug: string } }) => {
  ...
  const handleBookNowClick = () => {
    //
    if (!checkinDate || !checkoutDate) return toast.error("Please provide check in / check out date");
